...
public class update_delete_anniversary_form extends JFrame {
    ...
    private JComboBox da,mon,select;
               public update_delete_anniversary_form(){
                   
     selec=new JLabel("select contact:");
    select=new JComboBox();
        phone =new JTextArea("update_delete_anniversary_form");
     ...
     DefaultComboBoxModel iinput =new  DefaultComboBoxModel();
       iinput.addElement("jan");
         iinput.addElement("feb");
           iinput.addElement("mar");
             iinput.addElement("april");
               iinput.addElement("may");
                 iinput.addElement("june");
                   iinput.addElement("july");
                   iinput.addElement("aug");
                   iinput.addElement("sept");
                   iinput.addElement("oct");
                   iinput.addElement("n");
