...
public class update_delete_reminder_form extends JFrame {

    private JTextArea phone;
    private JButton save,back;
    private JLabel entry_id,name,enter_date,day,month,year,enter,selec,ENT;
    private JTextField entry,nam,yr,ent,ET;
    private JComboBox da,mon,select;
               public update_delete_reminder_form(){
                   
                   
                   ET=new JTextField(50);
           ENT=new JLabel("Enter reminder text:");        
     selec=new JLabel("select contact:");
    select=new JComboBox();
        phone =new JTextArea(" update_delete_reminder_form");
     ...
     back.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent arg0) {
               ...
               update_delete_birthday_form input= new update_delete_birthday_form();
    ...
    add(back);
     ...
     add(yr);
      ...
      setLayout(null);
       ...
       ET.setBounds(110,260,100,30);
       ENT.setBounds(10,260,100,30);      
      selec.setBounds(10,220,100,30);
      select.setBounds(110,220,100,30);
