...
public class anniversary_entry_form extends JFrame {

    private JTextArea phone;
    private JButton save,back;
    private JLabel entry_id,name,enter_date,day,month,year;
    private JTextField entry,nam,yr;
    private JComboBox da,mon;
               public anniversary_entry_form(){
    
        phone =new JTextArea(" anniversary_entry_form");
       save=new JButton("save");
        back=new JButton("Back");
        entry_id=new JLabel("Entry ID:");
        name= new JLabel("Name:");
        enter_date= new JLabel("enter_date:");
         //enter =new JTextField(50);
         day= new JLabel("day:");
    ...
    // add(enter);
     ...
     add(yr);
      ...
      setLayout(null);
       enter_date.setBounds(20,140,100,30);
        // enter.setBounds(250,140,130,30);
         month.setBounds(230,140,100,30);
         mon.setBounds(270,140,100,30);
           year.setBounds(380,140,100,30);
          yr.setBounds(420,140,100,30);
            day.setBounds(90,140,100,30);
            da.setBounds(120,140,100,30);
